...
import com.example.cash_you.adapters.AdapterManageCategories;
...
import com.example.cash_you.dialogs.DialogFragmentManageBPC;
...
import com.example.cash_you.viewmodels.Card;
import com.example.cash_you.viewmodels.Setting;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Setting loadDefCat = new Setting(inflater, R.drawable.ic_database_plus_white_24dp, getString(R.string.title_settings_defaultcategories), getString(R.string.subtitle_settings_defaultcategories),
                new View.OnClickListener() { @Override public void onClick(View v) {
                    ...
                    CategoryManager.getInstance().LoadDefaultCategories(_activitytype);
