...
import com.example.cash_you.models.Person;
import com.example.cash_you.models.Transaction;
import com.example.cash_you.activities.ActivityDetailsTransaction;
...
public class AdapterDetailsTotals
{
    ...
    private ActivityDetailsTransaction _activity;
    ...
    private SparseArray<Double> _totals; // Money owed to you, negative means you owe them

    //Activity type (Expense or income) (0 or 1)
    private Transaction.TRANSACTION_TYPE activityType;
    ...
    public class TransactionTotalsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        TransactionTotalsViewHolder(View itemView)
        {
            super(itemView);
        ...
        void bind(String a, String b, Double v){
